...
class OpenCVConan(ConanFile):
    ...
    url = "https://github.com/Solar-Framework/conan-solar/recipes/opencv/4.4.0"
    author = "Conan SolAR"
    ...
    def _configure_cmake(self):
        ...
        # GAPI
        cmake.definitions['BUILD_opencv_gapi'] = self.options.gapi
    ...
    def package_info(self):
        ...
        if self.settings.os != 'Android' and self.option.gapi:
